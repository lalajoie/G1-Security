...
if($_SESSION['username']==null){
    ?><script>alert("Login first!"); 
        window.location.replace("g1-Security/loginform.php");
</script>
<?php
}
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="pages/activity.php" class="nav-link">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Live Feed Video</span>
              </div>
            </div> </A>
          </div>
          <!-- /.col -->
